        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={`text-sm font-semibold transition-colors duration-355 ${
                    isActive
                      ? isScrolled
                        ? "text-secondary font-bold underline decoration-2 underline-offset-4"
          ...
          <button
            ...
            className={`lg:hidden p-2 focus:outline-none transition-colors ${
              isScrolled || isOpen ? "text-slate-700 hover:text-secondary" : "text-white hover:text-secondary"
            }`}
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`text-lg font-bold transition-colors duration-250 ${
